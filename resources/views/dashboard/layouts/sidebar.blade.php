@php
    $hasEmployeePermissions =
        ...
        Auth::user()->can('project.view') ||
        Auth::user()->can('department.view') ||
        Auth::user()->can('blog.view') ||
        Auth::user()->can('service_project.view') ||
        ...
        <ul class="metismenu" id="menu">
            ...
            <li><a href="{{ route('dashboard') }}">
                    ...
                    <svg width="22px" height="22px" viewBox="0 0 24 24" fill="none"
                        ...
                        <path
                            ...
                            fill="#ffffff" stroke="#000000" stroke-width="1.5" stroke-miterlimit="10" />
                        <path
                            ...
                            fill="#000000" fill-opacity=".16" stroke="#000000" stroke-width="1.5"
            ...
            @if (Auth::user()->employees)
                <li><a href="{{ route('my_project.index') }}">
                        ...
                        <svg width="22px" height="22px" style="margin-right: 6px;" viewBox="0 0 24 24" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path
                            ...
                            <g opacity="0.4">
                                ...
                                <path d="M18 4H14C12 4 11 5 11 7V17C11 19 12 20 14 20H18" stroke="#292D32"
            ...
            @if ($hasEmployeePermissions)
                @if (auth()->user()->can('blog.view'))
                    <li><a href="{{ route('filament.sdadmin.resources.blogs.index') }}">
                ...
                @if (Auth::user()->can('project.view'))
                    <li><a href="{{ route('project.index') }}">
                            {{-- <i class="fa fa-line-chart"></i> --}}
                            <svg width="22px" height="22px" style="margin-right: 6px;" viewBox="0 0 24 24"
                ...
                @if (auth()->user()->can('service_project.view'))
                    <li><a href="{{ route('service-projects.index') }}">
                            {{-- <i class="icon icon-form"></i> --}}
                            <svg fill="#000000" width="22px" height="22px" viewBox="0 0 32 32" id="icon"
                                xmlns="http://www.w3.org/2000/svg">
                                <defs>
                                    <style>
                                        .cls-1 {
                ...
                @if (auth()->user()->roles()->first()->name == 'superadmin')
                    ...
                    <li><a href="{{ route('invoice.generate') }}">
                            ...
                            <span class="nav-text text-dark">Invoice Generate</span></a></li>
                @endif
                    ...
                    <li><a class="has-arrow" href="javascript:void()" aria-expanded="false">
                            ...
                            <svg width="22px" height="22px" viewBox="0 0 24 24" fill="none"
                                ...
                                <path d="M9 22H15C20 22 22 20 22 15V9C22 4 20 2 15 2H9C4 2 2 4 2 9V15C2 20 4 22 9 22Z"
                                    ...
                                    stroke-linejoin="round" />
                                <g opacity="0.4">
                                    <path d="M15.5703 18.4996V14.5996" stroke="#292D32" stroke-width="1.5"
                                        stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                                    <path d="M15.5703 7.45V5.5" stroke="#292D32" stroke-width="1.5"
                                        stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                                    <path
                                    ...
                                    <path d="M8.42969 18.4998V16.5498" stroke="#292D32" stroke-width="1.5"
                                        stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                                    <path d="M8.42969 9.4V5.5" stroke="#292D32" stroke-width="1.5"
                                        stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                                    <path
